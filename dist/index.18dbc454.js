...
function getHeader(params) {
    ...
    nav.addEventListener("click", (event)=>{
        ...
        if (event.target.classList.contains("navigation__mainpage")) (0, _mainJs.router).navigate("/");
        if (event.target.classList.contains("navigation__catalog")) (0, _mainJs.router).navigate("/catalog");
        if (event.target.classList.contains("navigation__basket")) (0, _mainJs.router).navigate("/basket");
    });
...
},{"b224caeb7caf0dc1":"61B45","8b283eaf5610e6e0":"lgJ39"}]},["gEwwu","1SICI"], "1SICI", "parcelRequiref298")
